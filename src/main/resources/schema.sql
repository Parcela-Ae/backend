DROP ALL OBJECTS;
create table address (id serial primary key, complement varchar(255), latitude varchar(255), longitude varchar(255), neighborhood varchar(255), number varchar(255), public_area varchar(255), city varchar(255), state varchar(255), uf varchar(255), zip_code varchar(255), user_id integer, primary key (id));
