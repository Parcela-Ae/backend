insert into state (id, name) values (1, 'Pernambuco');
insert into state (id, name) values (2, 'São Paulo');

insert into city (id, name, state_id) values (1, 'Recife', 1);
insert into city (id, name, state_id) values (2, 'Olinda', 1);
...
insert into address (id, city_id, complement, latitude, longitude, neighborhood, number, public_area, user_id, zip_code) values (1, 1, 'Apto 303', null, null, 'Espinheiro', '300', 'Av. Agamenon Magalhães', 1, '38220834');
insert into address (id, city_id, complement, latitude, longitude, neighborhood, number, public_area, user_id, zip_code) values (2, 2, null, null, null, 'Centro', '105', 'Presidente Kennedy', 1, 38777012);
...
insert into address (id, city_id, complement, latitude, longitude, neighborhood, number, public_area, user_id, zip_code) values (3, 3, null, null, null, 'Centro', '2106', 'Avenida Paulista', 2, 39867024);
